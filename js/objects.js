...
books[0] = createBook("The Passage", "Justin", "Cronin");
books[1] = createBook("The Wheel of Time", "Robert", "Jordan");
books[2] = createBook("Wizard's First Rule", "Terry", "Goodkind");
books[3] = createBook("The Name of The Wind", "Patrick", "Rothfuss");
books[4] = createBook("A Wrinkle in Time", "Madeline", "L'Engle");
